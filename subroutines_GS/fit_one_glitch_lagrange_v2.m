function [theta, yhat, drift] = fit_one_glitch_lagrange(data2fit, weight, index, Greens, ND2, NDS, typefit, lagrangemult, iax)
    %
...
%          if index == 2291 || index == 20657 || index == 168734 || index == 21407
%             figure(200000+index)
%             subplot(3,3, iax)
